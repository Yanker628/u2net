...
class PresetTrain:
    def __init__(self, base_size: Union[int, List[int]], crop_size: int,
                 h_flip_prob=0.5, mean=(0.474, 0.494, 0.505), std=(0.162, 0.1523, 0.152)):
        self.transforms = Compose([
            ToTensor(),
            Resize(base_size, resize_mask=True),
...
class PresetEval:
    def __init__(self, base_size: Union[int, List[int]], mean=(0.474, 0.494, 0.505), std=(0.162, 0.1523, 0.152)):
        self.transforms = Compose([
            ToTensor(),
            Resize(base_size, resize_mask=False),
            Normalize(mean=mean, std=std),
        ])
